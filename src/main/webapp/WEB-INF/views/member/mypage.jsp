...
주소<input type="text" value="${login.post }"name="post" id="sample4_postcode" placeholder="우편번호">
...
<input type="reset" onclick="location.href='Main.jsp'" value="취소">
<input type="button" onclick="location.href='WithdrawalForm.jsp'" value="회원탈퇴">
</form>
