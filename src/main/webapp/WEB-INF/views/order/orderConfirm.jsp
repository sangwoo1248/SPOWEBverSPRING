...
<input type="hidden" name="sCode" value="${cDTO.sCode}">
<input type="hidden" name="sName" value="${cDTO.sName}">
<input type="hidden" name="sPrice" value="${cDTO.sPrice}">
<input type="hidden" name="sSize" value="${cDTO.sSize}">
				...
				<table width="100%" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td class="td_default" width="80"><img
							src="image/items/${cDTO.sImage}.jpg" border="0" align="center"
							width="80" /></td>
						<td class="td_default" width="300" style='padding-left: 30px'>
						${cDTO.sName}
							<br> <font size="2" color="#665b5f">
							[옵션 : 사이즈(${cDTO.sSize}), 색상(${sDTO.gColor})]
						</font></td>
						<td class="td_default" align="center" width="110">${cDTO.sPrice}
						</td>
					...
					<tr>
						...
						<td class="td_default" align='right'>${cDTO.sAmount * cDTO.sPrice}원</td>
					</tr>
				</table> <tr>
			<td>
					<hr size="1" color="CCCCCC">
