...
<c:forEach var="xxx" items="${cList}">
  <c:set var="totalSum" 
  value="${totalSum + xxx.sPrice*xxx.sAmount }"/>
...
<input type="hidden" name="num" value="${xxx.num}" >
					...
					<tr>
						...
						<img src="image/items/${xxx.sImage}.jpg" border="0" align="center"
							width="80" /></td>
						<td class="td_default" width="300" style='padding-left: 30px'>
						${xxx.sName}
							<br> <font size="2" color="#665b5f">
							[옵션 : 사이즈(${xxx.sSize}), 색상(${xxx.sColor})]
						</font></td>
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="1"
					...
					<tr>
						...
						<td height="35" class="td_default">
							...
							name="addr2" id="addr2" size="100" placeholder="지번주소"> 
							<!-- 다음주소 끝 -->
						</td>
					</tr>
