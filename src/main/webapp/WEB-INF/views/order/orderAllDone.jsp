...
<table width="70%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="td_default" align="center"><b>${orderName}</b> 님의 주문이
			안전하게 처리되었습니다.</td>
	</tr>
   ...
   <!--  변수 선언 -->
    ...
    <!-- 누적 -->
		<c:set var="totalSum" value="${totalSum + xxx.sPrice * xxx.sAmount }" />		
				<tr>
					<td height="35" class="td_default">
						<span class="a_default">${xxx.sName} </span>
					</td>
					<td height="35" class="td_default" align="center">
						<span  id = "price1">${xxx.sPrice}</span>원
					</td>
					<td height="35" class="td_default" align="center">
						<span id = "num1">${xxx.sAmount}</span>개
					</td>
					<td height="35" class="td_default" align="center">
						<span>${xxx.sPrice * xxx.sAmount}</span>원
					</td>
				</tr>
